                    ...
                    <div class="container wow bounceInDown" data-wow-duration="5s">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-8 text-center slide-text">
                                <h1><xsl:value-of select="//exercice[1]/titre"/></h1>
                                <p><xsl:value-of select="//exercice[1]/commentaire"/></p>
                            </div><!-- End col-md-8-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main_heading">
                                <font size="5pt"><p align="center"><xsl:value-of select="//exercice[1]/texte"/></p></font>
                                <br/>
                                
                                <img src="images/Capture.PNG" class="center"></img>
                                <br/>
                                <br/>
                                <div  class="text-center"><span class="underline"></span></div>
                                <br/>
                                <br/>
                                <font size="5pt"><p align="center"><xsl:value-of select="//exercice[1]/xml"/></p></font>
                                <font size="5pt"><p align="center"><a href="images/exo1.PNG" download="images/exo1.PNG">Tableau</a></p></font>
                                <font size="5pt"><p align="center"><a href="exercice_1/exercice_1.xml" download="exercice_1/exercice_1.xml">Exercice 1 (XML)</a></p></font>
                            </div>
                        </div><!-- End col-md-12 -->
                    </div><!-- End row -->
