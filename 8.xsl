                    ...
                    <div class="container wow bounceInDown" data-wow-duration="5s">
                        <div class="row">
                            <div class="col-md-offset-2 col-md-8 text-center slide-text">
                                <h1><xsl:value-of select="//exercice[7]/titre"/></h1>
                                <p><xsl:value-of select="//exercice[7]/commentaire"/></p>
                            </div><!-- End col-md-8-->
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main_heading">
                                <font size="5pt"><p align="center"><a href="exercice_8/RegroupeParClassesAnciennete.xsl" download="exercice_8/RegroupeParClassesAnciennete.xsl"><xsl:value-of select="//exercice[7]/fichier[1]"/></a></p></font>
                                <br/>
                                <font size="5pt"><p align="center"><a href="exercice_8/exo8.xsl" download="exercice_8/exo8.xsl"><xsl:value-of select="//exercice[7]/fichier[2]"/></a></p></font>
                                <br/>
                                <font size="5pt"><p align="center"><a href="exercice_8/exo8.html" download="exercice_8/exo8.html"><xsl:value-of select="//exercice[7]/fichier[3]"/></a></p></font>
